...
<svelte:head>
  <title>Cookie Bot GTM Consent - Contact Page</title>
</svelte:head>
    ...
    <div class="lg:w-1/2 md:w-2/3 mx-auto">
      ...
      >
        ...
        <div class="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
          <a href="." class="text-brand-dark">example@email.com</a>
...
{#if showToast}
  <div
    transition:fade
    id="toast"
    class="fixed bg-green-500 text-white px-4 py-2 text-lg rounded"
    role="alert"
  >
